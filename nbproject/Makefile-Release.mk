...
${OBJECTDIR}/Ajudas.o: Ajudas.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ajudas.o Ajudas.c

${OBJECTDIR}/Categoria.o: Categoria.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Categoria.o Categoria.c
...
${OBJECTDIR}/Dificuldade.o: Dificuldade.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dificuldade.o Dificuldade.c

${OBJECTDIR}/Genero.o: Genero.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Genero.o Genero.c

${OBJECTDIR}/Jogadas.o: Jogadas.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Jogadas.o Jogadas.c

${OBJECTDIR}/Jogo.o: Jogo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Jogo.o Jogo.c
...
${OBJECTDIR}/Pergunta.o: Pergunta.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pergunta.o Pergunta.c

${OBJECTDIR}/Resposta.o: Resposta.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Resposta.o Resposta.c

${OBJECTDIR}/TipoResposta.o: TipoResposta.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TipoResposta.o TipoResposta.c

${OBJECTDIR}/TipoUtilizador.o: TipoUtilizador.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TipoUtilizador.o TipoUtilizador.c
